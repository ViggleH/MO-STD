...
lb = [200, -40, 40, 40, 0, 10, -10, -10, -10, -10]; % Lower bounds for decision variables
ub = [500, 40, 100, 160, 5, 400, 10, 10, 10, 10]; % Upper bounds for decision variables
...
title('Pareto Fronts at Different $N_{\mathrm{rays}}$ (Polynomial Lens, FlexyDos3D)', Interpreter='latex');
legend('show', 'Interpreter', 'latex', 'Location', 'best');
grid on;
hold off;
%% Define the Output Folder
% Set the output folder (for example, 'Data/Conic')
outputFolder = fullfile('Data', 'Poly');
